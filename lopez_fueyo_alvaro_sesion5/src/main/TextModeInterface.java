...
public class TextModeInterface {
	...
	public void run() throws IOException {
		System.out.println("Comandos Herramientas: cuadrado, circulo, triangulo, seleccion, undo, redo");
		System.out.println("Comandos Ratón: pinchar x,y / mover x,y / soltar x,y / undo / redo");
